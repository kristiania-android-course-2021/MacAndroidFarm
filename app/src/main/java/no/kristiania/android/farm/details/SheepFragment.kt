...
class SheepFragment : Fragment(R.layout.fragment_animal) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.imageBigger.setImageResource(R.drawable.sheep)
        binding.textNameAnimal.text = getString(R.string.sheep)
